...
The website is responsive in smaller screen device. I came up with an idea to add a button that will open up the nav bar when in smaller screen. However, due to to my lack of understanding in advanced CSS I was not able to create. Therefore, I ended up with using display:block to create a vertical navbar  
